...
export class init1663995087086 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Supplier" ("id" SERIAL NOT NULL, "Supplier_name" character varying(255) NOT NULL, "city_id" integer NOT NULL, "Supplier_address" character varying(255) NOT NULL, "details" text, "is_partner" boolean NOT NULL, "active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_3a62ac86b369b36c1a297e9ab26" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "image" ("id" SERIAL NOT NULL, "Supplier_id" integer, "Supplier_product_id" integer, "transport_company_id" integer, "transport_company_product_id" integer, "filename" character varying(100) NOT NULL, "url" character varying(254) NOT NULL, "bucket" character varying(100) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_d6db1ab4ee9ad9dbe86c64e4cc3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "Supplier_product" ("id" SERIAL NOT NULL, "Supplier_id" integer NOT NULL, "room_type_id" integer NOT NULL, "quantity" integer NOT NULL, "service_price" numeric(10,2) NOT NULL, "details" text, "active" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_0b87dc3ed5933797bb789bfc0c2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Supplier" ADD CONSTRAINT "FK_b21702b66543e890807df0fb7d0" FOREIGN KEY ("city_id") REFERENCES "city"("id") ON DELETE RESTRICT ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "image" ADD CONSTRAINT "FK_53fc08ddd5425dec101ce5cfa76" FOREIGN KEY ("Supplier_id") REFERENCES "Supplier"("id") ON DELETE RESTRICT ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "image" ADD CONSTRAINT "FK_8fb6b8a2e64ecdba987f20db162" FOREIGN KEY ("Supplier_product_id") REFERENCES "Supplier_product"("id") ON DELETE RESTRICT ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "promo_offer_Supplier_product" ADD CONSTRAINT "FK_161f881fd19c3897b130eec0d59" FOREIGN KEY ("promo_offer_id") REFERENCES "promo_offer"("id") ON DELETE RESTRICT ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "promo_offer_Supplier_product" ADD CONSTRAINT "FK_de6100256003659e87f13ac902f" FOREIGN KEY ("Supplier_product_id") REFERENCES "Supplier_product"("id") ON DELETE RESTRICT ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "offer_Supplier_product" ADD CONSTRAINT "FK_77deea2067406dc375e84f69073" FOREIGN KEY ("offer_id") REFERENCES "offer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer_Supplier_product" ADD CONSTRAINT "FK_2eae39d914456f7a75a6d05f5c6" FOREIGN KEY ("Supplier_product_id") REFERENCES "Supplier_product"("id") ON DELETE RESTRICT ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "Supplier_product" ADD CONSTRAINT "FK_e2d138e3851ced2bb0b5c79d755" FOREIGN KEY ("room_type_id") REFERENCES "room_type"("id") ON DELETE RESTRICT ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "Supplier_product" ADD CONSTRAINT "FK_30a5fae5c299837bd3fbdab520f" FOREIGN KEY ("Supplier_id") REFERENCES "Supplier"("id") ON DELETE RESTRICT ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "Supplier_product" DROP CONSTRAINT "FK_30a5fae5c299837bd3fbdab520f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "Supplier_product" DROP CONSTRAINT "FK_e2d138e3851ced2bb0b5c79d755"`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer_Supplier_product" DROP CONSTRAINT "FK_2eae39d914456f7a75a6d05f5c6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "offer_Supplier_product" DROP CONSTRAINT "FK_77deea2067406dc375e84f69073"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "promo_offer_Supplier_product" DROP CONSTRAINT "FK_de6100256003659e87f13ac902f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "promo_offer_Supplier_product" DROP CONSTRAINT "FK_161f881fd19c3897b130eec0d59"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Supplier" DROP CONSTRAINT "FK_b21702b66543e890807df0fb7d0"`,
    );
    await queryRunner.query(
