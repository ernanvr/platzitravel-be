...
export class addUserModule1665376561212 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customer" ADD CONSTRAINT "UQ_5d1f609371a285123294fddcf3a" UNIQUE ("user_id")`);
        await queryRunner.query(`ALTER TABLE "agent" ADD "user_id" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "agent" ADD CONSTRAINT "UQ_031462988904ed291dd85171a86" UNIQUE ("user_id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "agent" DROP CONSTRAINT "UQ_031462988904ed291dd85171a86"`);
        await queryRunner.query(`ALTER TABLE "agent" DROP COLUMN "user_id"`);
        await queryRunner.query(`ALTER TABLE "customer" DROP CONSTRAINT "UQ_5d1f609371a285123294fddcf3a"`);
        ...
        await queryRunner.query(`ALTER TABLE "customer" ADD "email" character varying(254) NOT NULL`);
